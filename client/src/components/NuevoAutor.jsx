        ...
        <div>
            ...
            <form onSubmit={guardarAutor}>
                ...
                <div className='form-group'>
                    ...
                    <input type="text" id="imagen" name="iamgen" value={imagen} onChange={(e) => setImagen(e.target.value)} className="form-control"/>
                </div>
                ...
                <div className='form-check'>
                    ...
                    <label className='form-check-label' htmlFor='novelagrafica'>Autor de Novelas Graficas</label>
                </div>
                <div className='form-check'>
